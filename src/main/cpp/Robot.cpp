...
{
    m_tank_drive->SetMotorOutputByPercentage(
        m_driver_controller->GetYDB(frc::GenericHID::JoystickHand::kLeftHand), 
        m_driver_controller->GetYDB(frc::GenericHID::JoystickHand::kRightHand));
}
